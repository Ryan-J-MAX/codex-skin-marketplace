...
const themes = [
  {
    ...
    tags: ["dark", "cyberpunk"],
    preview: IMG_BASE + "cyberpunk-city.jpg?v=" + IMG_VER,
  ...
  },
  {
    ...
    preview: IMG_BASE + "cherry-blossom.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 256
  },
  {
    ...
    tags: ["dark", "minimal"],
    preview: IMG_BASE + "ocean-deep.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 189
  },
  {
    ...
    tags: ["dark", "minimal"],
    preview: IMG_BASE + "aurora-night.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 145
  },
  {
    ...
    tags: ["light", "minimal"],
    preview: IMG_BASE + "zen-mountain.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 112
  },
  {
    ...
    tags: ["dark", "minimal"],
    preview: IMG_BASE + "galaxy-space.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 176
  },
  {
    ...
    tags: ["dark", "cyberpunk"],
    preview: IMG_BASE + "neon-noir.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 267
  },
  {
    ...
    tags: ["light", "minimal"],
    preview: IMG_BASE + "sunset-gold.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 134
  },
  {
    ...
    tags: ["dark", "cyberpunk"],
    preview: IMG_BASE + "hacker-matrix.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 312
  },
  {
    ...
    tags: ["dark", "anime"],
    preview: IMG_BASE + "sakura-night.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 134
  },
  {
    ...
    tags: ["dark", "cyberpunk"],
    preview: IMG_BASE + "vaporwave.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 210
  },
  {
    ...
    tags: ["light", "minimal"],
    preview: IMG_BASE + "autumn-maple.jpg?v=" + IMG_VER,
    download: INSTALL_SCRIPT_URL,
    downloads: 89
  }
];